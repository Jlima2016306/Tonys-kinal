...
import org.juliolima.bean.Presupuesto;
   ...
   try{
     ...
     public void nuevo (){
        switch (tipoDeOperacion){
            ...
            }else if(txtCantidadPresupuesto.getText().equals("")){
                JOptionPane.showMessageDialog(null, "Debe ingresa laa Cantidad del Presupuesto ");
    ...
    public void imprimirReporte(){
        ...
        GenerarReporte.mostrarReporte("ReportePresupuesto.jasper", "Reporte Presupuesto"
                , parametros);
    }    
